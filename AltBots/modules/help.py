...
HELP_STRING = f"★ 𝗨ɴᴋɴᴏᴡɴ𝟽 𝗦ᴘᴀᴍ 𝗛ᴇʟᴘ 𝗠ᴇɴᴜ ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @UNKNOWN07_000**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/+EBf3Wo1lt7hhY2E1"),
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/+R2Ec5wk0E3RhN2Zl")
    ]
  ]
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://telegra.ph/file/7630198de6f37f582a607.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own Unknown7 Spam Bots !! @UNKNOWN07_000", cache_time=0, alert=True)
